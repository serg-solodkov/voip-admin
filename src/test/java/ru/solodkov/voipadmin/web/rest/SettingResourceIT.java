...
import ru.solodkov.voipadmin.service.SettingService;
...
class SettingResourceIT {
    ...
    public static Setting createEntity(EntityManager em) {
        Setting setting = new Setting().textValue(DEFAULT_TEXT_VALUE);
        return setting;
    }
    ...
    public static Setting createUpdatedEntity(EntityManager em) {
        Setting setting = new Setting().textValue(UPDATED_TEXT_VALUE);
        return setting;
    }
