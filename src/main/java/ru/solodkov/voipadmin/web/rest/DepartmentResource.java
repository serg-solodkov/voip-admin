...
import ru.solodkov.voipadmin.repository.DepartmentRepository;
import ru.solodkov.voipadmin.service.DepartmentService;
...
/**
 * REST controller for managing {@link ru.solodkov.voipadmin.domain.Department}.
 */
@RestController
@RequestMapping("/api")
